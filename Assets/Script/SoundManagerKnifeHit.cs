...
public class SoundManagerKnifeHit : MonoBehaviour {

	public static SoundManagerKnifeHit instance;
	...
	public void PlaySingle(AudioClip clip,float vol=1f)
	{
		...
		if (GameManagerKnifeHit.Sound && clip !=null) {
	...
	{
		if(GameManagerKnifeHit.Vibration)
			Handheld.Vibrate ();
